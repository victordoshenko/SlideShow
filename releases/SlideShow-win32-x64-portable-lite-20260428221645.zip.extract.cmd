@echo off
setlocal
set "ARCHIVE_BASE=SlideShow-win32-x64-portable-lite-20260428221645.zip"
set "COPY_LIST="SlideShow-win32-x64-portable-lite-20260428221645.zip.001"+"SlideShow-win32-x64-portable-lite-20260428221645.zip.002""
