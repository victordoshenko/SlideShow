@echo off
setlocal
set "ARCHIVE_BASE=SlideShow-win32-x64-portable-lite-20260428220306.zip"
set "COPY_LIST="SlideShow-win32-x64-portable-lite-20260428220306.zip.001"+"SlideShow-win32-x64-portable-lite-20260428220306.zip.002""
