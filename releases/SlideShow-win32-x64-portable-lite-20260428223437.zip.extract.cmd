@echo off
setlocal
set "ARCHIVE_BASE=SlideShow-win32-x64-portable-lite-20260428223437.zip"
set "COPY_LIST="SlideShow-win32-x64-portable-lite-20260428223437.zip.001"+"SlideShow-win32-x64-portable-lite-20260428223437.zip.002""
